    ...
    <v-content>
        ...
        <v-card>
            <v-container
                    ...
                    grid-list-lg
            >
                <div class="choose">C'est bien noté !</div>
                <div style="text-align: center">
                    Nous avons bien transmis au restaurant vos choix de plats. Nous vous souhaitons un agréable moment au restaurant !
                    <br />
                    <br />
                    <img src="../assets/illustration.png" style="width:90%" />
                </div>
            </v-container>
        </v-card>
    </v-content>
